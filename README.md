...
- Workout creation and tracker UI.
- Superadmin dashboard features to register new Gym tenants.
- S3 / Cloudflare R2 file uploads for member avatars and gym logos.
